...
function MakeCard(name, cardnumber, expiration, seccode) {
  this.name = name;
...
var Erin = new MakePerson("Erin", "June", 5);
var ErinCard = new MakeCard("Erin", 1000, "5/15", 230);
var test = new bindCard(Erin, ErinCard);
console.log(test);
